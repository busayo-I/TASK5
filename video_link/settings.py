"""
Django settings for video_link project.
...
SECRET_KEY = 'django-insecure-%=7a3_sj43gi0(vwm+1502bus()%%+1l2zz8t-n@*!98v@^q46'
...
WSGI_APPLICATION = 'video_link.wsgi.application'
...
# Define the URL prefix for media files (uploaded files)
MEDIA_URL = '/media/'
